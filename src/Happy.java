...
public class Happy {
	...
	private String AllFile = "happyAll.txt";
    
    public Happy(String wordX, String POS) {
    	this.word = wordX;
    	if (POS.equals("noun")) {
    		fileName = "happyNouns.txt";
    	}
    	else if (POS.equals("adverb")) {
    		fileName = "happyAdverbs.txt";
    	}
    	else if (POS.equals("verb")) {
    		fileName = "happyVerbs.txt";
    	}
    	else if (POS.equals("adjective")) {
    		fileName = "happyAdjectives.txt";
    	}
    	try {
			addData();
		} catch (IOException e) {
